...
hparams = tf.contrib.training.HParams(
	...
	num_freq = 257, # (= n_fft / 2 + 1) only used when adding linear spectrograms post processing network
	...
	#Tacotron
	outputs_per_step = 21, #number of frames to generate at each decoding step (speeds up computation and allows for higher batch size)
